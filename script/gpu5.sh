bash script/plot_surface_adv.sh -20 70 -10 5 cifar_torch_data10 adv_data_torch_data10.h5
bash script/plot_surface_adv.sh -20 90 -20 10 cifar_torch_data100 adv_data_torch_data100.h5
